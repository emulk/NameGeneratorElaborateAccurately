...
const _ADJECTIVE_ = [
    'Undefined',
    'Problem', 'budgeting', 'problems', 'model', 'language', 'techniques', 'system', 'languages', 'approach',
    'Models', 'formulation', 'systems', 'methods', 'algorithm', 'environment', 'solution', 'interface', 'technique', 'method',
    'Applications', 'example', 'analysis', 'framework', 'services', 'solutions',
    'Facilities', 'skills', 'demonstration', 'stage', 'computer', 'kit', 'procedure', 'format',
    'Theory', 'capability', 'methodology', 'capabilities', 'algorithms', 'large', 'library', 'paradigm',
    'Users', 'caap', 'concepts', 'tools', 'procedures', 'processes', 'course', 'kits', 'constructs', 'interfaces',
    'Small', 'software', 'tests', 'machines', 'computers', 'code', 'user', 'courses', 'codes', 'concept', 'logic',
    'Budget', 'see', 'approaches', 'tasks', 'task', 'formulations', 'matrix', 'mode', 'equation', 'environments', 'errors', 'simulation', 'scheme',
    'Based', 'relaxation',
    'Data', 'Advanced', 'Open', 'Learn', 'Awesome', 'Homemade',
    'Accurate', 'Adorable', 'All', 'Alleged', 'Ancient', 'Angry',
 ...
 */
const _PLURALNOUN_ = [
    'Science', 'Hacking', 'Code', 'Builder', 'Java', 'Programing', 'Design', 'Tools', 'Source',
    'Blockchain', 'Bootstrap', 'Bot', 'Robotics', 'Simulation', 'Computing',
 ...
 */
const _VERB_ = [
    'Based', 'Enabled', 'Developed', 'Provided', 'Networked', 'Study', 'Playing',
    'Allow', 'Require', 'Building', 'Shared', 'Integrate', 'Running', 'Connected',
    'Failed', 'Automated',
...
/**
 * Generate a new name for the above arrays
 */
export function NewNameGenerator() {
    let adjective = _ADJECTIVE_[Math.floor((Math.random() * _ADJECTIVE_.length) + 1)];
    let plural = _PLURALNOUN_[Math.floor((Math.random() * _PLURALNOUN_.length) + 1)];
    let verb = _VERB_[Math.floor((Math.random() * _VERB_.length) + 1)];
    let averb = _ADVERB_[Math.floor((Math.random() * _ADVERB_.length-1) + 1)];

    let name =
        adjective.charAt(0).toUpperCase() + adjective.slice(1) +
        plural.charAt(0).toUpperCase() + plural.slice(1) +
        verb.charAt(0).toUpperCase() + verb.slice(1) +
        averb.charAt(0).toUpperCase() + averb.slice(1);
    return name;
}
